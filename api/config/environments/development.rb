...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = ['http://10.80.122.133']
  config.action_cable.allowed_request_origins = ['localhost:3000']
  config.action_cable.allowed_request_origins = ['10.80.122.133:3000']
  config.action_cable.allowed_request_origins = ['electron://altair']
  config.action_cable.allowed_request_origins = ['0.0.0.0:4000']
