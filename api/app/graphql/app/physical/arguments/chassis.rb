  ...
  module Physical
    module Arguments
      ...
      class Chassis < ::Types::BaseInputObject
        ...
        argument :ports, [::App::Physical::Arguments::Port], as: :ports_attributes, required: false
        argument :components, [::App::Physical::Arguments::Component], as: :components_attributes, required: false
